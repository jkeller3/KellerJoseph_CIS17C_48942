...
OBJECTFILES= \
	...
	${OBJECTDIR}/SelfOrganizingList.o \
	${OBJECTDIR}/main.o
...
${OBJECTDIR}/SelfOrganizingList.o: SelfOrganizingList.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SelfOrganizingList.o SelfOrganizingList.cpp
